...
const UserBlockPage = () => {
    ...
    const users = [
        { user_id: 1, username: "user1 blocked", displayName: "User 1", profilePicturePath: "path..." },
        { user_id: 2, username: "user2 blocked", displayName: "User 2", profilePicturePath: "path..." },
        { user_id: 3, username: "user3 blocked", displayName: "User 3", profilePicturePath: "path..." },
        { user_id: 4, username: "user4 blocked", displayName: "User 4", profilePicturePath: "path..." },
